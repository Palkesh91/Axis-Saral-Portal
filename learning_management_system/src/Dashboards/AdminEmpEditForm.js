...
const AdminEmpEditForm = () => {
 ...
 useEffect(()=>{
  ...
  const handleSubmit=(event)=>{
    ...
    if(!employee.name || !employee.email || !employee.password || !employee.date_of_birth || !employee.role || !employee.gender || !employee.contact || !employee.address){
...
export default AdminEmpEditForm;