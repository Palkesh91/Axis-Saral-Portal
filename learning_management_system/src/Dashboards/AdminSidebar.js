  ...
  return (
    <div style={{ position: "relative", zIndex: 9999 }}>
      <nav id="sidebar" style={{ backgroundColor:"#2f4050", color: "white" }}>
        ...
        >
          <h2 className="sidebar-heading">AXIS SARAL</h2>
          <h3 className="sidebar-heading">Learning Management System</h3>
        </div>
        {employee && (
          <ul
